...
tagLst = [['library_animations', 'animation', 'asset', 'subject'],
...
class SimpleJudgingObject:
    ...
    def checkKeywords(self, context):
        ...
        inputKeywordList = GetXmlContent(FindXmlChild(root, "library_animations", "animation", "asset", "keywords")).split()
        ...
        outputKeywordList = GetXmlContent(FindXmlChild(root, "library_animations", "animation", "asset", "keywords")).split()

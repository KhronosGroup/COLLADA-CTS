...
tagLst = ['library_animations', 'animation', 'asset', 'modified']
attrName = ''
attrVal = ''
dataToCheck = ''
...
class SimpleJudgingObject:
    ...
    def CheckDate(self, context):
        ...
        inputDate = ParseDate(GetXmlContent(FindXmlChild(root, "library_animations", "animation", "asset", "modified")))
        if inputDate == None:
        ...
        outputDate = ParseDate(GetXmlContent(FindXmlChild(root, "library_animations", "animation", "asset", "modified")))
        if outputDate == None:

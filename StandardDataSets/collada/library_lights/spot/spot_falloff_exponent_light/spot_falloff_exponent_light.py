...
tagLst = ['library_lights', 'light', 'technique_common', 'spot', 'falloff_exponent']
attrName = ''
attrVal = ''
dataToCheck = ''
...
class SimpleJudgingObject:
    ...
    def JudgeSuperior(self, context):
        ...
        if ( self.__assistant.CompareRenderedImages(context) ):
            if ( self.__assistant.CompareImagesAgainst(context, "_reference_spot_falloff_exponent_0", None, None, 5, True, False) ):

...
class SimpleJudgingObject:
    ...
    def JudgeSuperior(self, context):
        ...
        if ( self.__assistant.CompareRenderedImages(context) ):
            if ( self.__assistant.CompareImagesAgainst(context, "_reference_cube_green", None, None, 5, True, False) ):
                self.__assistant.CompareImagesAgainst(context, "_reference_cube_blue", None, None, 5, True, False)

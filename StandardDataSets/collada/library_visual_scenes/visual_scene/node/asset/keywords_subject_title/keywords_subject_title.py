...
tagLst = [['library_visual_scenes', 'visual_scene', 'node', 'asset', 'subject'],
...
class SimpleJudgingObject:
    ...
    def checkKeywords(self, context):
        ...
        inputKeywordList = GetXmlContent(FindXmlChild(root, "library_visual_scenes", "visual_scene", "node", "asset", "keywords")).split()
        ...
        outputKeywordList = GetXmlContent(FindXmlChild(root, "library_visual_scenes", "visual_scene", "node", "asset", "keywords")).split()

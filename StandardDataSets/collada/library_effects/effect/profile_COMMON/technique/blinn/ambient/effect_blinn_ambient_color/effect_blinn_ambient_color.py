...
tagLst = [['library_effects', 'effect', 'profile_COMMON', 'technique', 'blinn', 'ambient', 'color'], ['library_effects', 'effect', 'profile_COMMON', 'newparam', 'float4'], ['library_effects', 'effect', 'newparam', 'float4']]
attrName = ''
attrVal = ''
dataToCheck = ''
...
class SimpleJudgingObject:
    ...
    def JudgeSuperior(self, context):
        ...
        if ( self.__assistant.CompareRenderedImages(context) ):
            if ( self.__assistant.CompareImagesAgainst(context, "_reference_effect_blinn_ambient_black", None, None, 5, True, False) ):

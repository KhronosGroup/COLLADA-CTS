...
bakedLocation = ['library_effects', 'effect', 'profile_COMMON', 'technique', 'constant', 'transparent', 'color']
...
class SimpleJudgingObject:
    ...
    def JudgeBaseline(self, context):
        ...
        if ( self.__assistant.CompareRenderedImages(context) ):
            if ( self.__assistant.CompareImagesAgainst(context, "effect_constant_transparent_default") ):

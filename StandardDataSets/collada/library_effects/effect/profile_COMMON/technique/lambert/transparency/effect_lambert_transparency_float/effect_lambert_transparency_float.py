...
tagLst = [['library_effects', 'effect', 'profile_COMMON', 'technique', 'lambert', 'transparency', 'float'], ['library_effects', 'effect', 'profile_COMMON', 'newparam', 'float'], ['library_effects', 'effect', 'newparam', 'float']]
attrName = ''
attrVal = ''
dataToCheck = ''
...
class SimpleJudgingObject:
    ...
    def JudgeBaseline(self, context):
        ...
        if ( self.__assistant.CompareRenderedImages(context) ):
            if ( self.__assistant.CompareImagesAgainst(context, "_ref_lambert_transparency_0.", None, None, 5, True, False) ):

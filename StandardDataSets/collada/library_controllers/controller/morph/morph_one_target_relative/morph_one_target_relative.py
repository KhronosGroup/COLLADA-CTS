...
class SimpleJudgingObject:
    ...
    def JudgeExemplary(self, context):
        ...
        if ( self.__assistant.CompareRenderedImages(context) ):
            if ( self.__assistant.CompareImagesAgainst(context, "_reference_no_morph_three_pyramids", None, None, 5, True, False) ):
                self.__assistant.CompareImagesAgainst(context, "morph_one_target_normalized", None, None, 5, True, False)

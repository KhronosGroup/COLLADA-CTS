...
tagLst = [['library_materials', 'material'], ['library_visual_scenes', 'visual_scene', 'node', 'instance_geometry','bind_material', 'technique_common', 'instance_material']]
attrName = 'target'
attrVal = 'library_materials.dae#lambert1'
dataToCheck = ''
...
class SimpleJudgingObject:
    ...
    def CheckForURLTerm(self, context, tagList, urlTerm):
        ...
        for eachNode in outputElementList:
            pathNames = SplitPath( GetAttriByEle(eachNode, "target") )

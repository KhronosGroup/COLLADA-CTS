...
# show how we handle Exemplary badge only problem: for example, animations have only Exemplary badges defined. So only when a test pass this Exemplary test, we can 

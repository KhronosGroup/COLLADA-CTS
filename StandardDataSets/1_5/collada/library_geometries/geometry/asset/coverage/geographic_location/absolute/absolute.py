...
tagLst = [['library_geometries', 'geometry', 'asset', 'coverage', 'geographic_location', 'longitude'],
          ['library_geometries', 'geometry', 'asset', 'coverage', 'geographic_location', 'latitude'],
          ['library_geometries', 'geometry', 'asset', 'coverage', 'geographic_location', 'altitude']]
attrName = 'mode'
attrVal = ''
dataToCheck = ''

...
tagLst = ['library_kinematics_models', 'kinematics_model', 'asset', 'up_axis']
attrName = ''
attrVal = ''
dataToCheck = 'Z_UP'
...
class SimpleJudgingObject:
	...
	# if superior fails, no point in further checking
        ...
        # IS Z_AXIS ALLOWED TO TRANSFORM?  IF SO, WHAT TO TEST FOR?
        self.__assistant.ElementDataCheck(context, self.tagList, self.dataToCheck, "string"):

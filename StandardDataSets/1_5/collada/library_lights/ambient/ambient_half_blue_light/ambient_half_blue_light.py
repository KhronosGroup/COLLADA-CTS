...
tagLst = ['library_lights', 'light', 'technique_common', 'ambient', 'color']
attrName = ''
attrVal = ''
dataToCheck = ''
...
class SimpleJudgingObject:
    ...
    def JudgeSuperior(self, context):
        ...
        # Then compare images against a white ambient light reference test for non-equivalence
        # Last, check for preservation of element data
        if ( self.__assistant.CompareRenderedImages(context) ):
            if ( self.__assistant.CompareImagesAgainst(context, "_reference_ambient_white", None, None, 5, True, False) ):

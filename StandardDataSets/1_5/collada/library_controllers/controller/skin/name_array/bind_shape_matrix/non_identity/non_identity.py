...
class SimpleJudgingObject:
    ...
    def JudgeSuperior(self, context):
        ...
        if ( self.__assistant.CompareRenderedImages(context) ):
            if ( not self.__assistant.CompareImagesAgainst(context, "identity", None, None, 5, False) ):
                context.Log ("PASSED: Image should not and does not match identity test case.")

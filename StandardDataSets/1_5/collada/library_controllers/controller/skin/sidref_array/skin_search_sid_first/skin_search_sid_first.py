...
tagLst = ['library_controllers', 'controller', 'skin', 'source', 'SIDREF_array']
attrName = ''
attrVal = ''
dataToCheck = ''
...
class SimpleJudgingObject:
    ...
    def JudgeSuperior(self, context):
        ...
        # Compare the rendered images and then compare against reference for non-equivalence
        if ( self.__assistant.CompareRenderedImages(context) ):
            self.__assistant.CompareImagesAgainst(context, "skin_search_id_first", None, None, 5, True, False)

...
tagLstRoot = [['library_kinematics_scene', 'kinematics_scene', 'instance_kinematics_model']]
attrName = 'sid'
attrVal = 'inst_kin_greifer'
numericNodeList = []
...
class SimpleJudgingObject:
    ...
    def JudgeKinematicsBaseline(self, context):
        ...
        self.__assistant.SmartPreservation(context, self.tagListRoot, self.attrName, eachAttrVal, self.numericNodeList)

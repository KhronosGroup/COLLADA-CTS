...
tagLst = [['library_visual_scenes', 'visual_scene', 'node', 'asset', 'coverage', 'geographic_location', 'longitude'],
          ['library_visual_scenes', 'visual_scene', 'node', 'asset', 'coverage', 'geographic_location', 'latitude'],
          ['library_visual_scenes', 'visual_scene', 'node', 'asset', 'coverage', 'geographic_location', 'altitude']]
attrName = 'mode'
attrVal = ''
dataToCheck = ''

...
tagLst = ['library_animations', 'animation', 'sampler']
attrName = ['pre_behavior', 'post_behavior']
attrVal = ''
dataToCheck = ''
...
class SimpleJudgingObject:
    ...
    def JudgeSuperior(self, context):
        ...
        self.__assistant.AttributePreserved(context, self.tagList, self.attrName[0])
        self.__assistant.AttributePreserved(context, self.tagList, self.attrName[1])

...
tagLst = [['library_animations', 'animation', 'asset', 'coverage', 'geographic_location', 'longitude'],
          ['library_animations', 'animation', 'asset', 'coverage', 'geographic_location', 'latitude'],
          ['library_animations', 'animation', 'asset', 'coverage', 'geographic_location', 'altitude']]
attrName = ''
attrVal = ''
dataToCheck = ''

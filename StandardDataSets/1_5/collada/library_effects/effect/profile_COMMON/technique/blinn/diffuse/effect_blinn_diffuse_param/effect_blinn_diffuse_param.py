...
bakedLocation = ['library_effects', 'effect', 'profile_COMMON', 'technique', 'blinn', 'diffuse', 'color']
...
class SimpleJudgingObject:
    ...
    def JudgeSuperior(self, context):
        ...
        if ( self.__assistant.CompareRenderedImages(context) ):
            if ( self.__assistant.CompareImagesAgainst(context, "effect_blinn_diffuse_color") ):

...
tagLst = [['library_effects', 'effect', 'profile_COMMON', 'technique', 'blinn', 'shininess', 'float'], ['library_effects', 'effect', 'profile_COMMON', 'newparam', 'float'], ['library_effects', 'effect', 'newparam', 'float']]
attrName = ''
attrVal = ''
dataToCheck = ''
...
class SimpleJudgingObject:
    ...
    def JudgeSuperior(self, context):
        ...
        if ( self.__assistant.CompareRenderedImages(context) ):
            if ( self.__assistant.CompareImagesAgainst(context, "_reference_effect_blinn_shininess_0.", None, None, 5, True, False) ):

...
tagLst = [['library_effects', 'effect', 'profile_COMMON', 'technique', 'lambert', 'diffuse', 'color'], ['library_effects', 'effect', 'profile_COMMON', 'newparam', 'float4'], ['library_effects', 'effect', 'newparam', 'float4']]
attrName = ''
attrVal = ''
dataToCheck = ''
...
class SimpleJudgingObject:
    ...
    def JudgeBaseline(self, context):
        ...
        if ( self.__assistant.CompareRenderedImages(context) ):
            if ( self.__assistant.CompareImagesAgainst(context, "_ref_lambert_diffuse_black", None, None, 5, True, False) ):

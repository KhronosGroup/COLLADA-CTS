...
bakedLocation = ['library_effects', 'effect', 'profile_COMMON', 'technique', 'phong', 'emission', 'color']
...
class SimpleJudgingObject:
    ...
    def JudgeSuperior(self, context):
        ...
        if ( self.__assistant.CompareRenderedImages(context) ):
            if ( self.__assistant.CompareImagesAgainst(context, "effect_phong_emission_color") ):
